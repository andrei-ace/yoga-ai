...
// a non-numpy alternative for `detail::get_2darray()`.
    ...
    template <typename Numeric>
    void set_xlim3d(Numeric left, Numeric right, const long fig_number = 0)
    {
        detail::_interpreter::get();
        ...
        PyObject *set_xlim3d = PyObject_GetAttrString(axis, "set_xlim3d");
        if (!set_xlim3d)
            throw std::runtime_error("Attribute set_xlim3d not found.");
        Py_INCREF(set_xlim3d);

        PyObject *res = PyObject_Call(set_xlim3d, args, kwargs);
        if (!res)
            throw std::runtime_error("Call to set_xlim3d() failed.");
        Py_DECREF(set_xlim3d);
    ...
    template <typename Numeric>
    void set_ylim3d(Numeric left, Numeric right, const long fig_number = 0)
    {
        detail::_interpreter::get();
        ...
        PyObject *set_ylim3d = PyObject_GetAttrString(axis, "set_ylim3d");
        if (!set_ylim3d)
            throw std::runtime_error("Attribute set_ylim3d not found.");
        Py_INCREF(set_ylim3d);

        PyObject *res = PyObject_Call(set_ylim3d, args, kwargs);
        if (!res)
            throw std::runtime_error("Call to set_ylim3d() failed.");
        Py_DECREF(set_ylim3d);
    ...
    template <typename Numeric>
    void set_zlim3d(Numeric left, Numeric right, const long fig_number = 0)
    {
        detail::_interpreter::get();
        ...
        PyObject *set_zlim3d = PyObject_GetAttrString(axis, "set_zlim3d");
        if (!set_zlim3d)
            throw std::runtime_error("Attribute set_zlim3d not found.");
        Py_INCREF(set_zlim3d);

        PyObject *res = PyObject_Call(set_zlim3d, args, kwargs);
        if (!res)
            throw std::runtime_error("Call to set_zlim3d() failed.");
        Py_DECREF(set_zlim3d);
